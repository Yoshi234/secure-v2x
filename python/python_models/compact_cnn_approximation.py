...
class ReLU_poly_approx(torch.nn.Module):
    '''
    Layer for the quadratic approximation of the ReLU function given
    by the Delphi paper
    '''
    def __init__(self):
        super(ReLU_poly_approx, self).__init__()
        
    def forward(self, input):
        input = 0.1992 + 0.5002*input + 0.1997*input**2
        return input
...
class compact_cnn_approximation(torch.nn.Module):
    """
    ...
    def __init__(self, classes=2, channels=32, kernelLength=64, sampleLength=384):
        ...
        super(compact_cnn_approximation, self).__init__()
        ...
        self.relu_approx = ReLU_poly_approx()
    ...
    def forward(self, inputdata):
        ...
        # intermediate.shape = [314, 32, 1, 321]
        intermediate = ReLU_poly_approx()(intermediate)
        # intermediate.shape = [314, 32, 1, 321]
