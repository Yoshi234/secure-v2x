...
def img_size_exps(lbs_folder, imgs_folder):
    '''
    runs and saves the results / metrics of all specified experimental runs
    '''
    # img_size experiments
    const_params = {"batch_size":64, "model_name":'yolov5n', 'folder':'img_size_exps'}
...
def batch_size_exps(lbs_folder, imgs_folder):
    const_params = {"model_name":'yolov5n', "img_size":(288,288), 'folder':'batch_size_exps'}
    res_names = {"plaintext_val":True, "secure_val":False}
...
def model_type_exps(lbs_folder, imgs_folder):
    const_params = {"batch_size":32, "img_size":(288,288), 'folder':'model_type_exps', "num_batches":1}
    res_names = {"plaintext_val":True, "secure_val":False}
...
def main():
    ...
    img_size_exps(lbs_folder,imgs_folder)
    model_type_exps(lbs_folder,imgs_folder)
    batch_size_exps(lbs_folder,imgs_folder)
